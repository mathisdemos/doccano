...
class Img2seqAnnotationAdmin(admin.ModelAdmin):
    list_display = ('document', 'text', 'user')
    ordering = ('document',)
    search_fields = ('document',)
...
admin.site.register(Image2seqAnnotation, Img2seqAnnotationAdmin)
...
admin.site.register(Image2seqProject, ProjectAdmin)
